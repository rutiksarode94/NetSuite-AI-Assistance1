    ...
    function handleSendMessage(request) {
        ...
        try {
            const response = https.requestRestlet({
                scriptId: '5394',           // Your Restlet Script ID
                deploymentId: '1',          // Your Restlet Deployment ID
                method: 'POST',
...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .input-section textarea{flex:1;padding:15px;resize:none;height:50px;border-radius:6px;border:1px solid #ccc;}
    </style>
</head>
<body>
    <div class="container">
